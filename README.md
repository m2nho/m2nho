...
<!-- ===== TYPING ANIMATION ===== -->
<p align="center">
  <a href="https://github.com/m2nho">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=FF9900&center=true&vCenter=true&width=560&lines=Build.+Deploy.+Operate.;Container+Infra+%7C+IaC+%7C+CI%2FCD+%7C+Monitoring;GenAI+%26+RAG+Pipelines+on+AWS;Toward+Platform+Engineering+%26+AIOps" alt="Typing SVG"/>
  </a>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Seoul,%20Korea-FF9900?style=for-the-badge&logo=googlemaps&logoColor=white" alt="Location"/>
  <img src="https://komarev.com/ghpvc/?username=m2nho&style=for-the-badge&color=232F3E&label=PROFILE+VIEWS" alt="Profile Views"/>
</p>
...
```yaml
name: 이민호 (Minho Lee)
role: Cloud & DevOps Engineer @ Saltware (AWS Solutions Architect)
what_i_do:
  - EKS/ECS 기반 컨테이너 인프라 구축·운영
  - Terraform으로 인프라를 코드로 관리 (IaC)
  - CI/CD 파이프라인 · CloudWatch/EFK 모니터링 · 장애 대응
  - Amazon Bedrock 기반 GenAI/RAG 파이프라인 구축
experience: "1.5+ years · 27+ clients · 9 certifications"
now_exploring: [Platform Engineering, AIOps, GitOps, Internal Developer Platform]
motto: "아키텍처는 시작일 뿐, 운영으로 증명한다."
```
...
`EKS` · `ECS` · `Fargate` · `Lambda` · `Step Functions` · `API Gateway` · `Bedrock` · `OpenSearch` · `Boto3` · `ArgoCD` · `n8n`
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <img src="https://img.shields.io/badge/Boto3-232F3E?style=flat-square&logo=amazonaws&logoColor=FF9900"/>
    ...
    <td width="50%" valign="top">
      ...
      <img src="https://img.shields.io/badge/Rekognition-232F3E?style=flat-square&logo=amazonaws&logoColor=FF9900"/>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <img src="https://img.shields.io/badge/CloudTrail-232F3E?style=flat-square&logo=amazonaws&logoColor=FF9900"/>
      <img src="https://img.shields.io/badge/VPC%20Flow%20Logs-8C4FFF?style=flat-square&logo=amazonaws&logoColor=white"/>
    </td>
  </tr>
</table>
